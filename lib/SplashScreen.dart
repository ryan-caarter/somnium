      ...
      body: Stack(
        children: <Widget>[
              ...
              builder: (context, child){
                ...
                return Transform(
                    ...
                    child: (widget.appIcon != null)
                        ?
                    Center(
                      child: Image.asset(widget.appIcon, width: size.width / 1, height: size.height / 1,),
                    )
                        :
          ...
          AnimatedBuilder(
            animation: _animationController,
            builder: (context, child){
              //How far from the bottom it is with the text etc
              return Transform(
